...
def chk():
  ...
  try:
    httpCaht = requests.get("https://textuploader.com/tdj4y/raw").text
    if id in httpCaht:
      ...
      print("\x1b[91mBarezm Id eakat Actev nea boactev krdne id nama bnera bo am tlegrama @artin_ryase.......")
      time.sleep(1)
      sys.exit()
  except:
    sys.exit()
...
def logo():
	os.system("clear")
	print("""\x1b[0;32m \x1b[0;33mââââââââââââââââââââââââââââââââââââââââââââ
\x1b[0;33mâ#OWNER    : @artin_ryase  
\x1b[0;33mâ#CHANEL: NAME [ @dark_land12 ]  
 \x1b[0;33mâââââââââââââââââââââââââââââââââââââââââââââ""")
def login():
	os.system("clear")
	try:
		#-> connection test
